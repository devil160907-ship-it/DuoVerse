...
class ProductionConfig(Config):
    """Production configuration for PythonAnywhere - USING SQLITE"""
    DEBUG = False
    # Use SQLite in production - store database in the project directory
    SQLALCHEMY_DATABASE_URI = 'sqlite:////home/duo02/DuoVerse/database.db'
...
if IS_PRODUCTION:
    ...
    print("📦 Using production configuration with SQLite")
else:
    app_config = DevelopmentConfig
    print("🔧 Using development configuration with SQLite")
...
# Database configuration - force SQLite for both environments
# This overrides any MySQL configuration
if IS_PRODUCTION:
    # Explicitly set SQLite for production
    app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////home/duo02/DuoVerse/database.db'
    print(f"📁 SQLite database path: /home/duo02/DuoVerse/database.db")
else:
...
with app.app_context():
    try:
        ...
        if IS_PRODUCTION:
            db_path = '/home/duo02/DuoVerse'
            os.makedirs(db_path, exist_ok=True)
            print(f"📁 Ensured database directory exists: {db_path}")
        ...
        if IS_PRODUCTION:
            print("⚠️  Production database connection failed. Check permissions and path.")
...
def get_base_url():
    ...
    if IS_PRODUCTION:
        ...
        return "https://duo02.pythonanywhere.com"
    else:
